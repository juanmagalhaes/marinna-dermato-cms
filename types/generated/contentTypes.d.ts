...
export interface ApiDoctorProfileDoctorProfile extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    crm: Schema.Attribute.String & Schema.Attribute.Required;
    email: Schema.Attribute.Email;
    ...
    > &
      Schema.Attribute.Private;
    miniBio: Schema.Attribute.RichText;
    phones: Schema.Attribute.Component<'shared.phone', true>;
    photo: Schema.Attribute.Media<'images'>;
    publishedAt: Schema.Attribute.DateTime;
    rqe: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    aboutPreview: Schema.Attribute.Component<'shared.about-preview', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    faqPreview: Schema.Attribute.Relation<'oneToMany', 'api::faq.faq'>;
    featuredTreatments: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    locationBlock: Schema.Attribute.Component<'shared.location-block', false>;
    publicationsPreview: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiPublicationPublication extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    doiOrUrl: Schema.Attribute.String;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::default-seo.default-seo': ApiDefaultSeoDefaultSeo;
